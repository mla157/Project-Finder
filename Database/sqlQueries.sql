...
-- Exportiere Datenbank Struktur für finderdb
CREATE DATABASE IF NOT EXISTS `finderdb` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `finderdb`;

-- Exportiere Struktur von Tabelle finderdb.actor
...
INSERT INTO `movie` (`idMovie`, `title`, `year`, `Genre`, `description`, `language`, `imageUrl`) VALUES
	...
	(6, 'Deadpool', '2016-02-11', 5, 'Basierend auf Marvels unkonventionellstem Anti-Helden, erzählt DEADPOOL die Geschichte des ehemaligen Special Forces Soldaten und Söldners Wade Wilson, der - nachdem er sich einem skrupellosen Experiment unterzieht - unglaubliche Selbstheilungskräfte erlangt und sein Alter Ego Deadpool annimmt.', '', 'Images\\deadpool.jpg'),
	...
	(18, 'The Twin', '2017-01-1', 2, 'Eine Frau (Brigid Brannagh) tritt in Aktion, nachdem sie entdeckt hat, dass der Zwillingsbruder (Timothy Granaderos) vom Freund ihrer Tochter aus einer psychiatrischen Anstalt flüchtet und einen verdrehten Plan der Rache schlüpft.', '', 'Images\\twin.jpg'),
	...
	(41, 'I Feel Pretty', '2018-05-10', 5, 'Eine Frau, die mit Unsicherheit kämpft, erwacht von einem Sturz und glaubt, dass sie die schönste und fähigste Frau auf dem Planeten ist. Ihr neues Selbstvertrauen gibt ihr die Möglichkeit, furchtlos zu leben, aber was passiert, wenn sie merkt, dass sich ihr Aussehen nie verändert hat?', '', 'Images\\feelpretty.jpg'),
